...
namespace DreadyCodr\OnlineTime;
...
use DreadyCodr\OnlineTime\database\SQLite;
                ...
                switch ($args[0]) {
                    case "total":
                        if (!isset($args[1])) {
                            ...
                            strtolower($args[1]);
                            if ($this->getServer()->getPlayerByPrefix($args[1]) !== null) {
                                $name = $this->getServer()->getPlayerByPrefix($args[1])->getName();
